...
class MyGRUCell(nn.Module):
    def __init__(self, input_size, hidden_size):
        ...
        # ------------
        # FILL THIS IN
        self.w_ir = nn.Linear(self.input_size, self.hidden_size)
        self.w_hr = nn.Linear(self.hidden_size, self.hidden_size)

        self.w_iz = nn.Linear(self.input_size, self.hidden_size)
        ...
        self.b_r = nn.Linear(self.hidden_size, 1)
        self.b_z = nn.Linear(self.hidden_size, 1)
        self.b_g = nn.Linear(self.hidden_size, 1)
        # ------------
    ...
    def forward(self, x, h_prev):
        ...
        z = F.sigmoid(self.w_ir(x) + self.w_hr(h_prev))
        r = F.sigmoid(self.w_iz(x) + self.w_hz(h_prev))
